...
class App extends Component {
  ...
  generateRandomNumber = () => {
    ...
    this.setState({displayImage: generatedImage})
    console.log(randomNumber)
  }

  getImageresult = () => {
    const {activeTab} = this.state
    const filteredImage = imagesList.filter(each => each.category === activeTab)
  ...
  render() {
    ...
    const filteredImages = this.getImageresult()
    return (
      <>
        <div className="matchGameBgContainer">
            ...
            <div className="header-details">
              ...
              <ul className="scoreTimeContainer">
                <li className="scoreContainer">
                  <p className="score">
                    Score: <span className="display-score">{score}</span>{' '}
                  </p>
                </li>
                <li className="timeContainer">
                  ...
                  />
                  <p className="running-time">{runningTime} sec</p>
                </li>
              </ul>
            </div>
          </nav>
          {!showResults ? (
            <div className="game-section">
              <img src={displayImage.imageUrl} alt="match" />
